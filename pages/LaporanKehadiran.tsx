...
import { CheckCircleIcon, ExclamationCircleIcon, InformationCircleIcon, XCircleIcon, PrinterIcon } from '../constants';
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
          <html>
            ...
            <body class="p-8">
              <h1 class="text-2xl font-bold mb-4">Laporan Kehadiran</h1>
