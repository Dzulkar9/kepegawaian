...
export const UsersIcon = (props?: {className?: string}) => (
  <svg xmlns="http://www.w3.org/2000/svg" {...iconProps} {...props} viewBox="0 0 24 24">
...
export const BuildingOfficeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" {...iconProps} viewBox="0 0 24 24" className="h-7 w-7 text-primary">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6h1.5m-1.5 3h1.5m-1.5 3h1.5M6.75 21v-2.25a2.25 2.25 0 012.25-2.25h3a2.25 2.25 0 012.25 2.25V21M6.75 3c0-1.108.892-2 2-2h6c1.108 0 2 .892 2 2v1.5H6.75V3z" />
    </svg>
);
...
export const UserCircleIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A13.937 13.937 0 0112 16.5c2.57 0 4.993.649 7.026 1.768M15 12a3 3 0 11-6 0 3 3 0 016 0zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);

export const SearchIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const StarSolid = (props: React.SVGProps<SVGSVGElement>) => (
...
export const PrinterIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const CalendarDaysIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm-3 0h.008v.008H9v-.008zm-3 0h.008v.008H6v-.008zm3 3h.008v.008H9v-.008zm3 0h.008v.008H12v-.008zm3 0h.008v.008H15v-.008z" />
    </svg>
);

export const FingerPrintIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...iconProps} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0 1 19.5 10.5c0 2.92-.556 5.709-1.588 8.188a7.5 7.5 0 0 1-1.588 8.188m-6.364-16.376A7.5 7.5 0 0 1 12 10.5c0 2.92-.556 5.709-1.588 8.188a7.5 7.5 0 0 1-1.588 8.188m-6.364-16.376A7.5 7.5 0 0 1 4.5 10.5c0 2.92-.556 5.709-1.588 8.188a7.5 7.5 0 0 1-1.588 8.188m12.728-16.376A7.5 7.5 0 0 1 15 10.5c0 2.92-.556 5.709-1.588 8.188a7.5 7.5 0 0 1-1.588 8.188M9.75 8.25A.75.75 0 0 1 10.5 7.5h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75V8.25Zm.75 6a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008a.75.75 0 0 0-.75-.75h-.008ZM12 10.5a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Z" />
    </svg>
);

export const ChevronLeftIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
    </svg>
);

export const ChevronRightIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
    </svg>
);

export const ListBulletIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
    </svg>
);

export const ArrowTopRightOnSquareIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
